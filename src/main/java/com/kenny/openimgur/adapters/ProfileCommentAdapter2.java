 ...
 */
public class ProfileCommentAdapter2 extends BaseRecyclerAdapter<ImgurComment> {
    ...
    public ProfileCommentAdapter2(Context context, List<ImgurComment> comments, View.OnClickListener onClickListener) {
